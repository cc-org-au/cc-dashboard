...
import { THEMES, Avi, F } from "./ecoos/primitives";
import { DB } from "./ecoos/data";
import HomeScreen from "./ecoos/HomeScreen";
import WorkScreen from "./ecoos/WorkScreen";
import InboxScreen from "./ecoos/InboxScreen";
import PeopleScreen from "./ecoos/PeopleScreen";
import DataScreen from "./ecoos/DataScreen";
import FilesScreen from "./ecoos/FilesScreen";
import IntegrationsScreen from "./ecoos/IntegrationsScreen";
import SettingsScreen from "./ecoos/SettingsScreen";
import AccountScreen from "./ecoos/AccountScreen";
import NotifDrawer from "./ecoos/NotifDrawer";
import useIsMobile from "./ecoos/useIsMobile";
import {
  Home,
  Briefcase,
  Inbox,
...
export default function EcoOS() {
  ...
  const grouped = cmdResults.reduce((acc, r) => {
        ...
        >
          ...
          <div style={{ flex: 1, maxWidth: 400, minWidth: 0 }}>
            ...
            >
              ...
              >
                {isMobile ? "Search" : "Type / to search"}
              </span>
              {!isMobile && (
                <kbd
                  style={{
                ...
                >
                  ...
                  {[
                    ...
                    <button
                      ...
                      onMouseLeave={(e) => (e.currentTarget.style.background = "none")}
                    >
                      <span style={{ color: T.t3, display: "flex" }}>{item.icon}</span>
                      {item.l}
                    </button>
                  ))}
          ...
          {TABS.map((t) => {
            ...
            return (
              <button
                ...
                onMouseEnter={(e) => {
                  if (!active) e.currentTarget.style.color = T.t1;
                }}
                onMouseLeave={(e) => {
                  if (!active) e.currentTarget.style.color = T.t2;
                }}
              >
          ...
          >
            ...
            >
              ...
              <input
                ...
                placeholder="Jump to a page, search agents, actions..."
                style={{
                  flex: 1,
                  background: "none",
                  border: "none",
            ...
            <div>
              ...
              {cmdResults.length === 0 && (
                <div style={{ padding: "24px 16px", textAlign: "center", color: T.t3, fontSize: 13 }}>No results found</div>
              )}
            </div>
          </div>
        </div>
